...
const CGVScreen = () => {
  return (
    <Wrapper variant={pageTransition} initial='initial' animate='animate' exit='exit' >
      ...
      <p className='text'>
        <span className='font-weight-bold'>luminaires-cavallo.fr</span> est un site de commerce électronique accessible via internet à l'adresse suivant : www.luminaires-cavallo.fr
        Le site luminaires-cavallo.fr est édité par la socitié François Cavallo, micro-entreprise, inscrite au Répertoire des Métiers sous le numéro 828121145RM1301 et dont le siège social est situé au Grand Mas d'Avignon, Le Sambuc 13200 Arles.
        Contact par email ou via le formulaire contact.
        ...
        Toute commande suppose la consultation et l'acceptation expresse préalable et sans réserves des présentes conditions générales de vente, sans toutefois que cette acceptation soit conditionnée par une signature manuscrite de la part de l'utilisateur.

        Les conditions générales de vente pouvant faire l'objet de modifications, les conditions applicables sont celles en vigueur sur le site à la date de la commande.
      </p>
      <ol>
        <li>
        <p className="h4">Produits, disponibilité et prix</p>
          <ol>
            <li>
              <p className="h5">Disponibilité des produits à la vente en ligne</p>
              <p className='text'>
        ...
        <li>
        <p className="h4">Validation et paiement de la commande</p>
          <ol>
            <li>
              <p className="h5">Identification de l'acheteur</p>
              <p className='text'>
            ...
            <li>
            <p className="h5">Enregistrement et validation de la commande</p>
            <p className='text'>
            ...
            <li>
            <p className="h5">Paiement de la commande</p>
            <p className='text'>
            ...
            <li>
            <p className="h5">Mode de paiement</p>
            <p className='text'>
        ...
        <li>
        <p className="h4">Expédition et livraison des commandes</p>
          <ol>
            <li>
            <p className="h5">Généralités</p>
            <p className='text'>
            ...
            <li>
            <p className="h5">Livraison en relais colis</p>
            <p className='text'>
            ...
            <li>
              <p className="h5">Réception des marchandises par l'acheteur</p>
              <p className='text'>
            ...
            <li>
            <p className="h5">Délai de livraison</p>
            <p className='text'>
            ...
            <li>
            <p className="h5">Livraison non assurée</p>
            <p className='text'>
            ...
            <div className="font-weight-bold h5" style={{width:'300px',textIndent : '0', margin: '0 auto'}}>
              <span>
              François Cavallo<br/>
              Grand Mas d'Avignon, Le Sambuc<br/>
              13200 Arles
            </span>
            </div>
            <br/>
        ...
        <li>
        <p className="h4"> Conditions d'annulation</p>
        <ol>
          <li>
          <p className="h5">Droits de rétractation</p>
          <p className='text'>
          ...
          <p className='text'>
            En cas d'échange ou remboursement, l'acheteur renvoie le(s) produit(s) dans son(leurs) emballage(s) d'origine, intact(s), à l'adresse suivante :<br/><br/>
            <div className="font-weight-bold h5" style={{width:'300px',textIndent : '0', margin: '0 auto'}}>
              <span>
                François Cavallo<br/>
                Grand Mas d'Avignon, Le Sambuc<br/>
          ...
          <li>
            <p className="h5">Conditions de retour</p>
            <p className='text'>
        ...
        <ul className='h5'>
          <li>les dysfonctionnements liés à une utilisation anormale ou non conforme ou à un défaut d’entretien du produit</li>
          <li>les dysfonctionnements liés à l’usure normale des produits</li>
          <li>le remplacement des accessoires, pièces d’usure et consommables</li>
          <li>les dégradations liées aux divers chocs occasionnés aux produits ou une modification des produits par l’acheteur</li>
          <li>les défauts ou conséquences liés à toute cause extérieure</li>
        </ul>
        </li><br/>
        <li>
        <p className="h4">Litiges</p>
        <p className='text'>
        ...
        <li>
          <p className="h4">Gestion des données personnelles</p>
          <p className='text'>
