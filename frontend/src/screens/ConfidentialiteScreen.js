...
const ConfidentialiteScreen = () => {
  return (
    <Wrapper  variant={pageTransition} initial='initial' animate='animate' exit='exit'>
      ...
      <p>Pour toute information sur la protection des données personnelles, vous pouvez également consulter le site de la <a href='https://www.cnil.fr/fr/definition/commission-nationale-de-linformatique-et-des-libertes-cnil' target="_blank" rel="noreferrer">Commission Nationale de l'Informatique et des Libertés</a>.</p>

      <p>Les informations transmises aux Luminaires Cavallo ne sont jamais communiquées à des tiers ou revendues.</p><br/>

      <span className="font-weight-bold h4">Quelles données collectons-nous auprès de vous?</span><br/><br/>
      <p>Avec votre consentement préalable, lorsque vous utilisez le site des Luminaires Cavallo ou lorsque vous nous contactez, nous pouvons collecter les données suivantes : 
      </p>
      <ul>
        ...
        <li>mot de passe et date d’inscription (pour compte en ligne)</li>
        <li>votre opinion sur nos produits, avis et commentaires sur notre site internet, blog et réseaux sociaux</li>
        <li>informations de paiement (lorsque vous utilisez notre service sécurisé de paiement en ligne)</li>
        <li>votre historique d’achats</li>
        <li>toute demande particulière que vous pourriez nous adresser ou contenu que vous souhaitez partager</li>
        <li>toutes autres données personnelles que vous décidez de nous communiquer par courriel, téléphone ou sur les médias sociaux (lorsque vous souhaitez partager vos questions et préoccupations, par exemple)</li>
        <li>toutes autres informations relatives aux cookie</li>
      </ul>
      <p>
      ...
      <span className="font-weight-bold h4">Pour quels usages collectons-nous vos données personnelles?</span><br/><br/>
      <span className="font-weight-bold h5">- La gestion des commandes et la relation client</span><br/>
      <p>
      ...
      <span className="font-weight-bold h5">- La lutte contre la fraude</span><br/>
      <p>
      ...
      <span className="font-weight-bold h5">- Mieux cibler notre politique commerciale et améliorer le site et votre navigation, notamment grâce à l'usage de cookies</span><br/>
        <ul>
          <li>
      ...
      <span className="font-weight-bold h5">Qu’est ce qu’un cookie ?</span><br/>
      <p>
      ...
      <span className="font-weight-bold h5">Remarque : les réseaux sociaux et les contenus générés par l'utilisateur</span><br/>
      <p>
      ...
      <span className="font-weight-bold h5">Base légale du traitement de vos données personnelles et de vos droits</span><br/>
      <p>
        ...
        <p>En retour, vous avez le droit :</p>
        <ul>
          <li>de nous demander une copie de vos données personnelles.</li>
          <li>de nous demander de rectifier, de compléter, de clarifier, de supprimer vos données personnelles ou d’en limiter le traitement à des fins de marketing direct ou autre.</li>
          <li>de nous demander de transférer ces données à une autre organisation.</li>
          <li>de vous opposer à ce que vos données soient utilisées à des fins de prospection commerciale.</li>
        </ul>

      <span className="font-weight-bold h5">Conservation des données personnelles</span><br/>
      <p>
      ...
      <span className="font-weight-bold h5">Confidentialité de votre mot de passe</span><br/>
      <p>
      ...
      <span className="font-weight-bold h5">Transaction PayPal</span><br/>
      <p>
      ...
      <span className="font-weight-bold h5">Modification de notre politique de confidentialité</span><br/>
      <p>
      ...
      <span className="font-weight-bold h5">Contact</span><br/>
      <p>
      ...
      <br/>
      <a href={hackerman} download="hackerman.png"><button type='button' className='btn btn-dark'>Télécharger la page en pdf</button></a>
    </Wrapper>
  )
}
