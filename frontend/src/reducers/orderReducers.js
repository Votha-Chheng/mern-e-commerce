...
export const orderCreateReducer = (state={}, action) => {
  switch (action.type){
    ...
    case ORDER_CREATE_SUCCESS_TO_FALSE :
      return {...state, successCreateOrder : false }
